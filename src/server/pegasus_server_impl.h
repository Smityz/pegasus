...
public:
    ...
    virtual void on_detect_hotkey(const ::dsn::apps::hotkey_detect_request &args) override;
    virtual void
    on_stop_detect_hotkey(const ::dsn::apps::stop_hotkey_detect_request &args) override;
