...
int _khotkey_collector_operationValues[] = {
  hotkey_collector_operation::START,
  hotkey_collector_operation::STOP
};
const char* _khotkey_collector_operationNames[] = {
  "START",
  "STOP"
};
const std::map<int, const char*> _hotkey_collector_operation_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(2, _khotkey_collector_operationValues, _khotkey_collector_operationNames), ::apache::thrift::TEnumIterator(-1, NULL, NULL));
