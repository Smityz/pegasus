...
void hotkey_detect_response::printTo(std::ostream& out) const {
  ...
  out << ", " << "hashkey="; (__isset.hashkey ? (out << to_string(hashkey)) : (out << "<null>"));
  out << ")";
}
...
stop_hotkey_detect_request& stop_hotkey_detect_request::operator=(const stop_hotkey_detect_request& other144) {
  partition = other144.partition;
  __isset = other144.__isset;
  return *this;
}
stop_hotkey_detect_request& stop_hotkey_detect_request::operator=(stop_hotkey_detect_request&& other145) {
...
stop_hotkey_detect_response::stop_hotkey_detect_response(const stop_hotkey_detect_response& other146) {
  err = other146.err;
...
stop_hotkey_detect_response& stop_hotkey_detect_response::operator=(const stop_hotkey_detect_response& other148) {
  err = other148.err;
  __isset = other148.__isset;
  return *this;
}
stop_hotkey_detect_response& stop_hotkey_detect_response::operator=(stop_hotkey_detect_response&& other149) {
