...
MAKE_EVENT_CODE_RPC(RPC_DETECT_HOTKEY, TASK_PRIORITY_LOW)
MAKE_EVENT_CODE_RPC(RPC_STOP_DETECT_HOTKEY, TASK_PRIORITY_LOW)
MAKE_EVENT_CODE(LPC_ANALYZE_HOTKEY, TASK_PRIORITY_LOW)
} // namespace apps
} // namespace dsn
